                ...
                <div style={{ background: "var(--color-surface-2)", borderRadius: "var(--radius-lg)", border: "1px solid var(--color-border)", padding: "1rem" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.75rem" }}>
                    ...
                    {networkInfo.wifi.length > 0
                      ...
                      : <span className="badge badge-warning" style={{ marginLeft: "auto" }}>Not Connected</span>}
                  </div>
                  {networkInfo.wifi.length > 0 ? networkInfo.wifi.map((w, i) => (
                    <div key={i} style={{ display: "flex", flexDirection: "column", gap: "0.25rem", fontSize: "0.82rem" }}>
                      ...
                      <code style={{ background: "var(--color-surface-1)", padding: "0.2rem 0.4rem", borderRadius: "var(--radius-sm)", fontWeight: 600, letterSpacing: "0.02em" }}>{w.address}</code>
                ...
                <div style={{ background: "var(--color-surface-2)", borderRadius: "var(--radius-lg)", border: "1px solid var(--color-border)", padding: "1rem" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.75rem" }}>
                    ...
                    {networkInfo.ethernet.length > 0
                      ? <span className="badge badge-info" style={{ marginLeft: "auto" }}>Connected</span>
                      : <span className="badge badge-warning" style={{ marginLeft: "auto" }}>Not Connected</span>}
                  </div>
                  {networkInfo.ethernet.length > 0 ? networkInfo.ethernet.map((e, i) => (
                    <div key={i} style={{ display: "flex", flexDirection: "column", gap: "0.25rem", fontSize: "0.82rem" }}>
                      <div style={{ color: "var(--color-muted)" }}>{e.name}</div>
                      <code style={{ background: "var(--color-surface-1)", padding: "0.2rem 0.4rem", borderRadius: "var(--radius-sm)", fontWeight: 600, letterSpacing: "0.02em" }}>{e.address}</code>
