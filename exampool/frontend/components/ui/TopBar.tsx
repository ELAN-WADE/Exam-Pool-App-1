    ...
    <header className={styles.topbar}>
      ...
      <div className={styles.left}>
        ...
        <div className={styles.breadcrumb}>
          <span className={styles.breadcrumbRole}>{roleLabel}</span>
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={styles.breadcrumbSep}>
